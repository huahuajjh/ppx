...
<div class="new-body-context">
    ...
    <div class="new-body-context-val">
        ...
        <div class="bottom-news">
            ...
            <ul>
                <?php $return_xg = $this->_listdata("action=relation id=$id more=1  return=xg"); extract($return_xg); $count_xg=count($return_xg); if (is_array($return_xg)) { foreach ($return_xg as $key_xg=>$xg) { ?>
                <li>
                    <a href="<?php echo $xg['url']; ?>">
                        <h3><?php echo $xg['title']; ?></h3>
                        <img src="<?php echo $xg['yulantu']; ?>" alt="">
