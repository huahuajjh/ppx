...
<div class="subnav">
	...
	<div class="table-responsive mytable">
		...
		<?php } } ?>
		<tr >
		    <td colspan="9" align="left"> <input <?php if (!admin_auth($userinfo['roleid'], 'ip-del')) { ?>disabled<?php } ?> type="submit" class="btn btn-success btn-sm" value="<?php echo lang('a-del'); ?>" name="submit_del" />&nbsp;</td>
		</tr>
		</table>
		<?php echo $pagelist; ?>
		</form>
