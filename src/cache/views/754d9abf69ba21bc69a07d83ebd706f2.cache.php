    ...
    <div class="pinpai-top-bg">
        ...
        <div class="pinpai-top-menu-area">
            <ul class="pinpai-top-menu-area-btns">
                ...
                <li>
                    <a href="/index.php?c=content&a=list&catid=35" class="pinpai-btn-biaozhun"></a>
                </li>
                <li>
                    <a href="/index.php?c=content&a=list&catid=36" class="pinpai-btn-tiyan active"></a>
                </li>
            </ul>
        </div>
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(54); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(55); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(56); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(57); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(58); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(59); ?>" alt="">
    </div>
