...
<link href="<?php echo ADMIN_THEME; ?>luos/css/style.min.css?v=4.1.0" rel="stylesheet"><link href="<?php echo ADMIN_THEME; ?>images/table_form.css" rel="stylesheet" type="text/css" />    <link href="<?php echo ADMIN_THEME; ?>luos/css/style.min.css?v=4.1.0" rel="stylesheet">
		...
		<div class="col-tab">
			...
			<table width="100%" class="table_form">
				...
				<tr>
					...
					<input type="button" value="<?php echo lang('a-ind-67'); ?>" onClick="javascript:test_mail();" class="btn btn-success btn-sm"></td>
				</tr>           
				</tbody>
			</table>
			</div>
