...
<div class="subnav">
	...
	<div class="table-responsive mytable">
		...
		<?php } } ?>
		<tr height="25">
			<td colspan="8" align="left"><input type="button" class="btn btn-success btn-sm" value="<?php echo lang('a-ind-44'); ?>" name="submit_order" onClick="window.location.href='<?php echo url('admin/index/clearattack/'); ?>'">
