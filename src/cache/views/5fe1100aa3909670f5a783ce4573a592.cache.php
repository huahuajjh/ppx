...
<style type="text/css">
    ...
    <div class="pinpai-top-bg">
        ...
        <div class="pinpai-top-menu-area">
            ...
            <ul class="pinpai-top-menu-area-btns">
                <li>
                    <a href="/index.php?c=content&a=list&catid=8" class="pinpai-btn-xiyi active"></a>
                </li>
                <li>
    ...
    <div class="pinpai-top-bg">
        <img src="<?php echo block(24); ?>" alt="">
    </div>
    <div class="pinpai-hr"></div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(25); ?>" alt="">
    </div>
    <div class="pinpai-hr"></div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(26); ?>" alt="">
    </div>
    <div class="pinpai-hr"></div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(27); ?>" alt="">
    </div>
    <div class="pinpai-hr"></div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(28); ?>" alt="">
    </div>
