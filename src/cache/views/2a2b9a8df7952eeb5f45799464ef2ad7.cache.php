...
<style type="text/css">
    ...
    <div class="pinpai-top-bg">
        ...
        <div class="pinpai-top-menu-area">
            <ul class="pinpai-top-menu-area-btns">
                <li>
                    <a href="/index.php?c=content&a=list&catid=34" class="pinpai-btn-xiyi active"></a>
                </li>
                <li>
    ...
    <div class="pinpai-top-bg">
        <img src="<?php echo block(45); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(46); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(47); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(48); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(49); ?>" alt="">
    </div>
    <div class="pinpai-top-bg">
        <img src="<?php echo block(50); ?>" alt="">
    </div>
