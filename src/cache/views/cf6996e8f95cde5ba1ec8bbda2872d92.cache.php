...
<script type="text/javascript">var sitepath = "<?php echo SITE_PATH;  echo ENTRY_SCRIPT_NAME; ?>";</script><?php include $this->_include('admin/top.html'); ?>
...
<div class="subnav">
	...
	<div class="table-responsive mytable">
		...
		<tr>
			<th>&nbsp;</th>
			<td><input class="btn btn-success btn-sm" type="submit" name="submit" value="<?php echo lang('a-submit'); ?>" onClick="$('#load').show()" />
