...
<div class="subnav">
	...
	<div class="table-responsive mytable">
		...
		<tr>
			...
			<th width="80" align="left"><?php echo lang('a-mod-33'); ?></th>
			<th width="80" align="center"><?php echo lang('dr002'); ?></th>
		...
		<tr>
			...
			<td align="left"> </td>
			<td align="left"> </td>
            <td align="center"><?php if ($content['keywords']['show']) { ?><span class="label label-success">√</span><?php } else { ?><span class="label label-important">×</span><?php } ?></td>
		...
		<tr height="25">
			...
			<td align="left"> </td>
			<td align="left"> </td>
            <td align="center"><?php if ($content['thumb']['show']) { ?><span class="label label-success">√</span><?php } else { ?><span class="label label-important">×</span><?php } ?></td>
		...
		<tr>
			...
			<td align="left"> </td>
			<td align="left"> </td>
            <td align="center"><?php if ($content['description']['show']) { ?><span class="label label-success">√</span><?php } else { ?><span class="label label-important">×</span><?php } ?></td>
		...
		<tr style="<?php if ($t['formtype']=='merge') { ?>background-color:#FFC<?php } else if ($t['formtype']=='fields') { ?>background-color:#EEF3F7<?php } ?>">
			<td align="left">
			<input type="text" name="order_<?php echo $t['fieldid']; ?>" class="input-text" style="width:35px;" value="<?php echo $t['listorder']; ?>"></td>
			...
			<td align="center"><?php if ($t['isshow']) { ?><span class="label label-success">√</span><?php } else { ?><span class="label label-important">×</span><?php } ?></td>
			<td align="left">
		...
		<?php } } ?>
		<tr>
			<td colspan="8" align="left"><input <?php if (!admin_auth($userinfo['roleid'], 'model-editfield')) { ?>disabled<?php } ?> class="btn btn-success btn-sm" type="submit" name="submit" value="<?php echo lang('a-order'); ?>" /></td>
		</tr>
		</tbody>
		</table>
	    </form>
